        ...
        {selectable ? (
          ...
          >
            <Box display="flex" alignItems="center">
              {settingable && (
                <Tooltip title={t("component:gridHeader.titleSettingColumns")} placement="top-start" arrow={true}>
          ...
          (settingable || DrillDown) && (
            <TableCell padding="checkbox" className={classes.cellCheckbox} style={{ paddingLeft: 0 }}>
              <Box display="flex" alignItems="center">
                {settingable && (
                  <Tooltip title={t("component:gridHeader.titleSettingColumns")} placement="right" arrow={true}>
